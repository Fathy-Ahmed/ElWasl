...
export class HomePageComponent implements OnInit {
  ...
  // Mock authors with detailed portrait images and bios
  readonly authors = [
    {
      nameAr: 'نجيب محفوظ',
    ...
    },
    {
      ...
      countAr: '7 روايات',
      countEn: '7 Novels',
      bioAr: 'كاتبة تونسية وأستاذة جامعية، اشتهرت بروايتها الأكثر مبيعاً "في قلبي أنثى عبرية" والتي تميزت بعمقها الاجتماعي والديني.',
  ...
  // Distributors mock data for interactive world map
  ...
  openAuthorDetail(author: any): void {
  ...
  openDistributorDetail(distributor: any): void {
